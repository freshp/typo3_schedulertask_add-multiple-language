...
#
# Table structure for table 'tx_typo3schedulertaskaddmultiplelanguage_domain_model_coordinate'
#
CREATE TABLE tx_typo3schedulertaskaddmultiplelanguage_domain_model_coordinate (
